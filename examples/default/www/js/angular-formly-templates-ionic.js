...
$templateCache.put("fields/ion-textarea.html","<label class=\"item item-input\"><textarea rows=\"{{options.templateOptions.rows? options.templateOptions.rows: \'10\'}}\" placeholder=\"{{options.templateOptions.placeholder}}\" ng-model=\"model[options.key]\"></textarea></label>");
