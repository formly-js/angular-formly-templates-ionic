...
$templateCache.put("fields/ion-inline-input.html","<label class=\"item item-input\"><span class=\"input-label\">{{options.templateOptions.label}}</span> <input ng-model=\"model[options.key]\" type=\"{{options.templateOptions.type}}\"></label>");
